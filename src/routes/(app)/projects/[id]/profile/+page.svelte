...
<div class="space-y-6">
	...
	<div class="flex items-center justify-between">
		<div>
			...
			<p class="mt-1 text-sm text-gray-500">
				De bevestigde waarheid van dit project — alle AI-acties gebruiken dit profiel als basis.
			</p>
		</div>
	...
	{:else if editing}
		...
		<form on:submit|preventDefault={saveProfile} class="space-y-6">
			...
			<div class="rounded-card bg-white p-6 shadow-card">
				<h2 class="text-base font-semibold text-gray-900">Opdrachtgever</h2>
			...
			<!-- Financial & codes section -->
			<div class="rounded-card bg-white p-6 shadow-card">
				<h2 class="text-base font-semibold text-gray-900">Financieel &amp; classificatie</h2>
				<div class="mt-4 grid grid-cols-1 gap-4 sm:grid-cols-2">
					<div>
	...
	{:else}
		...
		<div class="space-y-6">
			...
			{#if isConfirmed && project.profile_confirmed_at}
				<InfoBanner
					type="info"
					message="Dit profiel is bevestigd op {new Date(project.profile_confirmed_at).toLocaleDateString('nl-NL', { day: 'numeric', month: 'long', year: 'numeric' })}. Wijzigingen worden gelogd in de audit trail."
				/>
			{/if}
