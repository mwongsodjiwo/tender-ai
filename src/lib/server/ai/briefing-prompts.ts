// Briefing prompt templates — system prompts for briefing and document generation

export const BRIEFING_COMPLETE_TAG = '[BRIEFING_COMPLEET]';

export const BRIEFING_SYSTEM_PROMPT = `# Rol en identiteit
...
export const GENERATION_SYSTEM_PROMPT = `# Rol en identiteit
